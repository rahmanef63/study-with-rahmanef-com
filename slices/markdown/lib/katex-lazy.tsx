 ...
 *  first math render and cached at module level — same pattern as
 *  MermaidBlock. Until the module lands, the raw TeX source shows as code,
 *  then the span upgrades in place. KaTeX sanitises its own HTML output. */
