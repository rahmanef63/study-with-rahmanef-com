# comments — per-lesson discussion (#16, phase-2)

> Frontend host = OS desktop shell (pivot 2026-07-07): alpha mounts this view in
> the lesson window-app, not the old route group. The Convex backend is unchanged
> by the pivot.
