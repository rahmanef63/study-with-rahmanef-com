...
/** Sudah dijawab? Diekspor karena `./run-progress.ts` memakainya untuk
 *  menghitung langkah yang selesai — impor DALAM slice, bukan lintas-slice. */
export function isDone(state: RunState, step: RunStep): boolean {
