...
| 5 | `app/landing` — landing page + marketing chrome + e2e smoke | v1 | #1, #2 | in-progress | alpha | main | 2a6e491 | Routes + progress slots wired (completionSlot di player, progressSlot + completedLessonIds di overview, member-gated mount); sisa: e2e smoke + verifikasi produksi; **v1 LAUNCH gate** |
