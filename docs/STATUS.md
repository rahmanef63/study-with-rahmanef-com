...
| 34 | ops: deploy modul seed + run 3 seed di prod + smoke kursus baru | v1.5 | #31–#33 | done | vps | main | — | dikonfirmasi owner via chat 2026-07-16 (laporan vps tidak di-file di repo; kursus baru live). Bila ada temuan tercecer, tambahkan ke drift log |
...
| 36 | ops: deploy v1.6 (modul asisten) + aktivasi env + smoke Alfa | v1.6 | #35 | open | vps/owner | — | — | env dulu baru deploy; smoke: /asisten gate anon, login → jawaban nyata, lesson-context, kill-switch check |
