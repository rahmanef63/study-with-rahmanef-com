...
| 27 | alpha: integrasi UI wave v1.3 — mount bell+inbox (os-shell header), SearchView, deep-link `/sertifikat/<completionId>`, anon login-gate resources-app (temuan zeta spec 9) | v1.3 | #21, #23, #24 | open | alpha | — | — | pola #20: mounting menyusul, TIDAK memblokir deploy backend #26; setelah mount → flip fixme spec 8 + hapus test.fail spec 9 |
