...
export function SumberBelajarCard({ slug }: { slug: string }) {
  return (
    <Link
      ...
      className="group flex h-full w-full items-center gap-3 rounded-[var(--radius)] border border-border bg-card p-4 text-left transition-colors hover:border-primary/30 hover:bg-accent/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
    >
