...
// Kelola › Statistik — instructor analytics: per-course summaries from the
// analytics slice, with a drill-down into CourseAnalyticsView. All data is
// derived server-side (bounded takes) and instructor+ gated in the Convex
// functions themselves — this tab is just the mount.
