...
// "Analisis Data dengan AI" seeds the POST-MATERI shape, and re-running it is a
...
import { ANALISIS_DATA_CURRICULUM as CURRICULUM } from "./_seed/analisisDataData";
...
const SEED = internal.seedAnalisisData.seedAnalisisDataContent;
...
const LEGACY_MODULES: { lessons: number; quiz?: number }[] = [
  ...
  { lessons: 3, quiz: 1 },
  { lessons: 3, quiz: 2 },
  { lessons: 2 }, // "Visualisasi" carried no quiz
  { lessons: 3, quiz: 3 },
];
...
describe("seedAnalisisData — preconditions", () => {
...
describe("seedAnalisisData — flat materi, no module tree", () => {
