// Kurikulum "Orkestrasi Multi-Agent untuk Proyek Nyata" — DATA saja, tanpa
// impor Convex.
//
...
//
// Isi Bahasa Indonesia dipindah apa adanya dari convex/seedMultiAgent.ts —
...
// di _seed/curriculum.ts mencarinya lewat judul yang sama. Code sample tetap
// memakai INDENTED code block (4 spasi, CommonMark) supaya bebas backtick.
//
// Dipakai oleh: convex/seedMultiAgent.ts (seedMultiAgent:seedMultiAgentContent)
import type { SeedCurriculum } from "./curriculum";

export const MULTI_AGENT_CURRICULUM: SeedCurriculum = {
