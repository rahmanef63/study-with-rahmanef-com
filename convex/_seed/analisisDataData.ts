// Kurikulum "Analisis Data dengan AI" — DATA saja, tanpa impor Convex.
//
// Bentuk baru (DECISIONS #37): kelas = DAFTAR MATERI BERURUTAN. Pohon modul
// dibuang; judul modul TIDAK dibawa masuk sebagai heading maupun kolom, dan
// kuis menggantung di KELAS, bukan di modul. Urutan array di bawah = urutan
// baca yang sudah dilihat pelajar (modul 1 lesson 1..n, modul 2, dst), jadi
// penempatan `courseLessons` 1..14 identik dengan yang sudah tayang.
//
// Isi Bahasa Indonesia dipindah apa adanya dari convex/seedAnalisisData.ts —
// perubahan ini struktural, bukan editorial. Judul materi HARUS tetap persis:
// slug produksi diturunkan dari judul oleh materiBackfill, dan probe idempoten
// di _seed/curriculum.ts mencarinya lewat judul yang sama. Code/prompt sample
// tetap memakai INDENTED code block (4 spasi, CommonMark) supaya bebas backtick.
//
// Dipakai oleh: convex/seedAnalisisData.ts (seedAnalisisData:seedAnalisisDataContent)
import type { SeedCurriculum } from "./curriculum";

export const ANALISIS_DATA_CURRICULUM: SeedCurriculum = {
