// Kurikulum "Bikin Aplikasi Web dengan AI" — DATA saja, tanpa impor Convex.
//
...
//
// Isi Bahasa Indonesia dipindah apa adanya dari convex/seedWebDev.ts —
...
//
// Dipakai oleh: convex/seedWebDev.ts (seedWebDev:seedWebDevContent)
import type { SeedCurriculum } from "./curriculum";

export const WEB_DEV_CURRICULUM: SeedCurriculum = {
  ...
  /** Urutan 1..17 = urutan penempatan di courseLessons. */
  lessons: [
    {
