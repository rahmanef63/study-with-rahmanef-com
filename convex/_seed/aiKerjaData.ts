// Kurikulum "AI untuk Produktivitas Kerja" — DATA saja, tanpa impor Convex.
//
...
// baca yang sudah dilihat pelajar (modul 1 lesson 1..n, modul 2, dst).
//
// Isi Bahasa Indonesia dipindah apa adanya dari convex/seedAiKerja.ts —
// perubahan ini struktural, bukan editorial. Code sample tetap memakai
// INDENTED code block (4 spasi, CommonMark) supaya bebas backtick.
//
// Dipakai oleh: convex/seedAiKerja.ts (seedAiKerja:seedAiKerjaContent)
import type { SeedCurriculum } from "./curriculum";

export const AI_KERJA_CURRICULUM: SeedCurriculum = {
  ...
  /** Urutan 1..14 = urutan penempatan di courseLessons. */
  lessons: [
    {
...
Kamu sudah punya dasar untuk menulis lebih cepat, mengolah spreadsheet, menyiapkan rapat, dan menyusun template sendiri — semuanya dengan alat gratis. Teruskan kebiasaan ini: simpan template yang berhasil, rutin verifikasi hasil, dan jaga data sensitif. Kalau ingin belajar lebih jauh, lanjutkan ke kelas lain di komunitas ini.`,
  ...
  /** Kuis menggantung di kelas (quizzes.courseId), bukan di modul. */
  quizzes: [
    {
